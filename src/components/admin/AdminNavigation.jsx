...
const AdminNavigation = () => {
    ...
    return (
        <header className="bg-slate-50 text-slate-700 px-6 py-4 flex justify-between items-center shadow-md">
            ...
            <div className="text-sm opacity-75 cursor-pointer" onClick={() => navigate("/articles")}>Articles</div>
            <div className="text-sm opacity-75 cursor-pointer" onClick={() => navigate("/article/add")}>Add Article</div>
        </header>
    )
}
